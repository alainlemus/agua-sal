<div class="min-h-screen flex flex-col items-center justify-start px-4 py-8">
    ...
    <div class="w-full max-w-md text-center">
        ...
        <h2 class="text-2xl text-red-400 font-bold mb-2">Enlace no válido</h2>
        <p class="text-gray-400 text-sm">{{ $tokenErrorMsg }}</p>
        <p class="text-gray-600 text-xs mt-4">Pídele a tu mesero que genere un nuevo enlace para ti.</p>
    </div>
