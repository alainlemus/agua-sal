...
<body class="bg-[#1c1c1c] text-gray-200 font-sans antialiased text-base selection:bg-[#E52B2B] selection:text-white">
    ...
    <nav x-data="{ open: false, scrolled: false, showMobileTrigger: false }"
        ...
        "
        :class="scrolled ? 'bg-[#1c1c1c]/95 backdrop-blur border-b border-gray-800' : 'bg-transparent border-b border-transparent'"
...
<div class="max-w-[90rem] mx-auto px-4 sm:px-6 lg:px-12 xl:px-8">
            <div class="flex flex-wrap justify-between items-center gap-y-4 transition-all duration-300 py-3 md:py-4"
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a href="/" class="flex items-center gap-2 transition-transform hover:scale-105 duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#E52B2B] focus-visible:ring-offset-2 focus-visible:ring-offset-[#1c1c1c] rounded">
                ...
                <div class="hidden md:flex items-center gap-4">
                    <a href="/menu"
                        class="inline-flex items-center gap-2 bg-[#006847] hover:bg-[#005236] text-white px-6 py-2 rounded font-bold uppercase tracking-widest text-sm transition-all shadow-lg shadow-green-900/30 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#006847] focus-visible:ring-offset-2 focus-visible:ring-offset-[#1c1c1c]">
                    ...
                    <a href="{{ $globalSiteInfo?->whatsapp ? 'https://wa.me/' . ltrim($globalSiteInfo->whatsapp, '+') : '#' }}" target="_blank" rel="noopener"
                        class="relative inline-flex items-center gap-2 bg-[#E52B2B] hover:bg-red-700 text-white px-6 py-2 rounded font-bold uppercase tracking-widest text-sm transition-all shadow-lg shadow-red-500/30 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#E52B2B] focus-visible:ring-offset-2 focus-visible:ring-offset-[#1c1c1c] reservar-btn">
                        <svg class="w-5 h-5 relative z-10" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    ...
                    <style>
                        .reservar-btn::before {
                            ...
                            background: #E52B2B;
                            animation: reservar-ring 2s ease-out infinite;
                            z-index: 0;
                        }
                        @keyframes reservar-ring {
        ...
        <div id="mobile-menu" x-show="open" x-transition:enter="transition ease-out duration-200"
            ...
            class="md:hidden bg-[#111] border-t border-gray-800 shadow-2xl" style="display:none" role="navigation"
            ...
            <div class="max-w-7xl mx-auto px-4 py-6 space-y-1">
                ...
                <div class="pt-4 border-t border-gray-800 flex flex-col gap-3">
                    <a href="/menu" @click="open=false"
                        class="inline-flex items-center justify-center gap-2 w-full bg-[#006847] hover:bg-[#005236] text-white px-6 py-3 rounded font-bold uppercase tracking-widest text-sm transition-all shadow-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-[#006847] focus-visible:ring-offset-2 focus-visible:ring-offset-[#111]">
                    ...
                    <a href="{{ $globalSiteInfo?->whatsapp ? 'https://wa.me/' . ltrim($globalSiteInfo->whatsapp, '+') : '#' }}"
                        ...
                        class="flex items-center justify-center gap-2 w-full bg-[#E52B2B] hover:bg-red-700 text-white px-6 py-3 rounded font-bold uppercase tracking-widest text-sm transition-all shadow-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-[#E52B2B] focus-visible:ring-offset-2 focus-visible:ring-offset-[#111]">
                        Reservar Ahora
                    </a>
    ...
    <!-- Footer -->
    <footer class="bg-black py-12 border-t border-gray-800" id="contact">
<div class="max-w-[90rem] mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div>
                    ...
                    @if ($globalSiteInfo?->tagline)
                        <p class="text-gray-400">{{ $globalSiteInfo->tagline }}</p>
                    @endif
                    ...
                    @endphp
                    @if (count($socials) > 0)
                        <div class="flex items-center gap-3 mt-5 flex items-center justify-center" role="list"
                            aria-label="Redes sociales">
                            @foreach ($socials as $social)
                                ...
                                <a href="{{ $social['url'] ?? '#' }}" target="_blank" rel="noopener"
                                    aria-label="{{ $label }}"
                                    class="text-gray-400 {{ $color }} transition-colors duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#E52B2B] focus-visible:ring-offset-2 focus-visible:ring-offset-black flex justify-center items-center shrink-0"
                                    role="listitem">
    ...
    <div id="cookie-banner" role="dialog" aria-modal="true" aria-labelledby="cookie-banner-title"
        ...
        style="display:none"
        class="fixed bottom-0 inset-x-0 z-[9998] bg-[#111] border-t border-gray-700 shadow-2xl px-4 py-5 flex flex-col sm:flex-row items-start sm:items-center gap-4">
        ...
        <div class="flex gap-3 shrink-0">
            ...
            <button @click="accept('all')"
                class="text-xs font-bold uppercase tracking-widest bg-[#E52B2B] hover:bg-red-700 text-white px-5 py-2 rounded transition-colors shadow-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-[#E52B2B] focus-visible:ring-offset-2 focus-visible:ring-offset-[#111]">
                Aceptar todo
            </button>
        </div>
    </div>
